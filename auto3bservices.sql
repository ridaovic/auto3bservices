...
--
-- Client :  127.0.0.1
-- Généré le :  Mer 23 Décembre 2015 à 13:45
...
(9, '2015-12-23', '2015-12-31', 20, 30, 7);
...
(1, '2015-12-25', '001', 2, 'actives', 1000, 2000, 1000, 7),
(2, '2015-12-24', '001', 2, 'active', 1500, 1500, 1000, 1),
(3, '2015-12-26', 'test', 4, 'Non payÃ©', 4, 4, 4, 5),
(4, '2015-12-26', 'test', 3, 'PayÃ©', 3, 4, 3, 6);
...
--
ALTER TABLE `factures`
  MODIFY `num_fact` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
